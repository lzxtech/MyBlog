...
$.ajax({
  ...
  data: {
    key: '24EBZ-TLBCZ-HKOXR-ZYPGD-ZVRKZ-JWFWQ',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(113.34499552, 23.15537143); //这里换成自己的经纬度
